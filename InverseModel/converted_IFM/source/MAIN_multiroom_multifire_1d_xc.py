...
numcomp = 4
numfire = 4  #numfire have to be smaller than numcomp, fire1 in comp1, fire 2 in comp2, etc
numsignal = 8
...
'''
n = size(time, 1)
HRR_pred = zeros(n, numfire) + 1000
least_error = zeros(n, 1) + 100
SIGNAL_pred = zeros(n, numsignal) + 20  #For now signal is temperature
...
jump_tol = 1
k_avg = 0
HRR_temp = zeros(1, numfire) + 1000
SIGNAL_lowfire = mcat([0, 0, 0, 0])
'''
